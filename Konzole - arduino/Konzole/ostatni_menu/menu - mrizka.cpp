...
const PROGMEM color_t settings_colors[] = {0,40179,33808};
  Item settings {settings_data, 75, settings_colors, color_white};
  ...
  Item atari {atari_data, 56, atari_colors, color_gray};
  ...
  Item pong {pong_data, 125, pong_colors, color_blue};

  const byte icon_count = 9;
  ...
  void drawScroll() {
    if(scroll_position != 0) {
      ...
      tft.fillTriangle(120, 55, 200, 55, 160, 35, color_light_blue);
    }
    if (scroll_position != icon_count-6) {
      ...
      tft.fillTriangle(120, 220, 200, 220, 160, 240, color_light_blue);
    }
  }
